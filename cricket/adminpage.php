    ...
    <header>
        <div class="header-content">
            <div class="header-content-inner">
                <div class="col-md-4">
                    <a href="update.php" class="btn btn-primary btn-lg"><h2 class="section-heading">Update Stats</h2></a>
                </div>
                <div class="col-md-4"></div>
                <div class="col-md-4">
                    <a href="viewfeedback.php" class="btn btn-primary btn-lg"><h2 class="section-heading">View Feedback</h2></a>
                </div>
            </div>
        </div>
    </header>
