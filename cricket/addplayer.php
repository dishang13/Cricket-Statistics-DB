...
<form role="form"  method="POST" action="">
	<fieldset>
		<legend>Give Player Details</legend>
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="text" name="span" required> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Matchesmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="bInningsmin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="HSmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="bRunsmin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="BFmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="bAveragemin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Fiftiesmin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Centuriesmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Ducksmin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="NOmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="bSRmin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Wicketsmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="4Formin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="5Formin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Ballsmin1" value="0" placeholder="0" width="10"> 
			</td>
			</tr>
			...
			<td style="font-size: 14px; color: #333333; padding:4px 0px; border-bottom:1px solid #b2b2b2;">
			<input type="number" name="Economymin1" value="0" placeholder="0" width="10">
			</td>
			</tr>
